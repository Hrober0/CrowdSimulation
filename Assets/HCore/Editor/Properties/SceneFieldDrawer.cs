...
namespace HCore.Editor
{
    ...
    {
        private const string SCENE_ASSET_PATH = "_sceneAsset";
        private const string SCENE_PATH_PATH = "_scenePath";
        ...
        {
            return property.FindPropertyRelative(SCENE_ASSET_PATH);
        }

        static SerializedProperty GetScenePathProperty(SerializedProperty property)
        {
            return property.FindPropertyRelative(SCENE_PATH_PATH);
        }
