...
namespace Tests.EditorTests.NavigationTests
{
    public class PolygonUtilsTests
    {
        ...
        public void CutIntersectingEdges_ShouldSplitIntoThree_WhenTwoIntersectionsOnSameEdge()
        {
            ...
            result.AsArray().ShouldContainKey(new EdgeKey(new(0, 0), new(3, 0)));
            result.AsArray().ShouldContainKey(new EdgeKey(new(3, 0), new(7, 0)));
            result.AsArray().ShouldContainKey(new EdgeKey(new(10, 0), new(7, 0)));
        ...
        public void CutIntersectingEdges_ShouldHandleThreeIntersectionsOnSameEdge()
        {
            ...
            result.AsArray().ShouldContainKey(new EdgeKey(new(10, 0), new(8, 0)));
            result.AsArray().ShouldContainKey(new EdgeKey(new(5, 0), new(8, 0)));
            result.AsArray().ShouldContainKey(new EdgeKey(new(2, 0), new(5, 0)));
            result.AsArray().ShouldContainKey(new EdgeKey(new(0, 0), new(2, 0)));
        ...
        public void CutIntersectingEdges_ShouldHandleMultipleIntersectionInOnePoint()
        {
            ...
            // Horizontal should be split into 4 pieces
            result.AsArray().ShouldContainKey(new EdgeKey(new(5, 0), new(0, 0)));
            result.AsArray().ShouldContainKey(new EdgeKey(new(10, 0), new(5, 0)));

            result.AsArray().ShouldContainKey(new EdgeKey(new(5, -1), new(5, 0)));
            result.AsArray().ShouldContainKey(new EdgeKey(new(5, 0), new(5, 1)));

            result.AsArray().ShouldContainKey(new EdgeKey(new(4, -1), new(5, 0)));
            result.AsArray().ShouldContainKey(new EdgeKey(new(5, 0), new(6, 1)));

            result.AsArray().ShouldContainKey(new EdgeKey(new(6, -1), new(5, 0)));
            result.AsArray().ShouldContainKey(new EdgeKey(new(5, 0), new(4, 1)));
        ...
        public void CutIntersectingEdges_ShouldCutEdge_WhenOnlyEdgeIsIntersected()
        {
            ...
            // Assert
            result.AsArray().ShouldContainKey(new EdgeKey(new(0, 0), new(5, 0)));
            result.AsArray().ShouldContainKey(new EdgeKey(new(5, 0), new(10, 0)));
            result.AsArray().ShouldContainKey(new EdgeKey(new(5, -1), new(5, 0)));
        ...
        public void CutIntersectingEdges_ShouldCutOverlappingPartially()
        {
            ...
            result.AsArray().ShouldContainKey(new EdgeKey(new(0, 0), new(5, 0)));
            result.AsArray().ShouldContainKey(new EdgeKey(new(5, 0), new(10, 0)));
            result.AsArray().ShouldContainKey(new EdgeKey(new(10, 0), new(15, 0)));
        ...
        public void CutIntersectingEdges_ShouldCutOverlappingCompletely_WhenEdgeIsInside()
        {
            ...
            result.AsArray().ShouldContainKey(new EdgeKey(new(0, 0), new(3, 0)));
            result.AsArray().ShouldContainKey(new EdgeKey(new(3, 0), new(7, 0)));
            result.AsArray().ShouldContainKey(new EdgeKey(new(7, 0), new(10, 0)));
        ...
        public void CutIntersectingEdges_ShouldCutOverlappingCompletely()
        {
            ...
            // Assert
            result.AsArray().ShouldContainKey(new EdgeKey(new(0, 0), new(10, 0)));
